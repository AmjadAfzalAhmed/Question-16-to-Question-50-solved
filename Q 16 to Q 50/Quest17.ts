...
let invitees:string[] = ['Amjad', 'Adeel','Furqan','Hayyan','Ali Mustafa','Haider']; //actual list
console.log(invitees);

let removedGuests:string[] = invitees.slice(0,3);//creates new list of removed guests
...
let cutList:string[] = invitees.slice(3,6) ; // it creates a new list of guests who are invited
